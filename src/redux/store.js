    ...
    Cards: [
      {
        ...
        description1: 'Der Neukundenzufluss bleibt oft hinter Deinen Erwartungen zurück',
      ...
      },
      {
        ...
        description1: 'Deine Kommunikation ist zu allgemein oder nicht gut genug auf die richtige Zielgruppe ausgerichtet?',
      ...
      },
      {
        ...
        description1: 'Du hast nicht die Zeit, Ressourcen und/ oder das Fachwissen, um Social-Media-Marketing erfolgreich zu betreiben.',
        description2: 'Wir übernehmen für Dich die komplette Planung, Umsetzung und Analyse von Werbekampagnen, damit Du Zeit und Kosten sparst und optimale Ergebnisse erzielen kannst.',
        result:'',
        img: 'https://via.placeholder.com/150',
      },
      {
        ...
        description1: 'Du benötigst, gerade in Zeiten von Fachkräftemange, fachliche Unterstützung, um die Herausforderung passende Mitarbeiter zu finden bestmöglich zu meistern?',
        description2: 'Du benötigst, gerade in Zeiten von Fachkräftemange, fachliche Unterstützung, um die Herausforderung passende Mitarbeiter zu finden bestmöglich zu meistern?',
        result:'',
        img: 'https://via.placeholder.com/150',
      },
      {
        ...
        description1: 'Du kämpfst damit, Deine Zielgruppe zu erreichen und weisst nicht, wie das am effektivsten geht?',
        description2: 'Wir entwickeln für Dich gezielte Sozial-Media-Strategien, damit Du Deine Markenbekanntheit zu steigern kannst, und sowohl potenzielle Kunden als auch Bewerber affektiv ansprichst.',
        result:'',
        img: 'https://via.placeholder.com/150',
      },
      {
        ...
        description1: 'Du hast Schwieruígkeiten, Deine Arbeitgebermarke so zu positionieren, dass sie als attraktiver Arbeitsplatz wahrgenommen wird?',
        description2: 'Mit stärken Deine Employer Brand, indem wir Dein Unternehmen auf Sozial Media als attraktiver Arbeitgeber dargestellt wird.',
        result:'',
        img: 'https://via.placeholder.com/150',
      },
    ],
