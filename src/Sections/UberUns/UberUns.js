            ...
            <div className="aboutUss flex flex-col my-10">         
                <div className=' w-screen flex  flex-col sm:flex-row'>
                  <div className='sm:w-1/2 flex pb-2 justify-center items-center'>
                    <p className='w-full sm:w-3/4 text-xs sm:text-sm text-center md:text-start px-5 md:px-0'>Wir blicken auf 35 Jahre Marketing- und Vertriebserfahrung zurück und mit dieser unterstützen wir die kleinen und mittelständischen Unternehmen im DACH-Raum.
                    <br/><br/>
                ...
                <div className=' w-screen flex'>
                  ...
                  <div className='w-full sm:w-1/2 flex justify-center items-center'>
                    <p className='w-full sm:w-3/4 sm:pt-2 text-xs sm:text-sm text-center md:text-start px-5 md:px-0 mt-2'>Unsere Unterstützung geht dabei weit über die reine Beratung hinaus. Wir begleiten unsere Kunden, auf Wunsch, bei jedem einzelnen Schritt. Praxisnahe und nachhaltige Lösungen praxisnah sind uns wichtig, damit unsere Partner nicht nur kurzfristige Erfolge erzielen, sondern sich langfristig im Wettbewerb behaupten können.
                    <br/><br/>
