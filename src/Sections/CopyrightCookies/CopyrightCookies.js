...
const CopyrightCookies = () => {
  return (
    <div className="copyright-cookies  flex items-center flex-col mt-10 mx-5">
      ...
      <br/>
      Dieser Haftungsausschluss ist als Teil des Internetangebots von MI Consulting and more e.K. zu betrachten, von dem aus auf diese Seite verwiesen wurde. Sofern Teile oder einzelne Formulierungen dieses Textes der geltenden Rechtslage nicht, nicht mehr oder nicht vollständig entsprechen sollten, bleiben die übrigen Teile des Dokuments in ihrem Inhalt und ihrer Gültigkeit davon unberührt. Anstelle der unwirksamen Regelung tritt diejenige wirksame Regelung, die dem wirtschaftlichen Zweck am nächsten kommt.
      </p>
      <button  className="relative mt-10 text-sm py-2"><a href="/" className="py-3 px-10">Go back</a></button>
    </div>
  );
};

export default CopyrightCookies;